              ...
              <div className="flex items-center justify-center lg:justify-start gap-3 sm:gap-6 flex-wrap">
                ...
                {tvDetails.popularity && (
                  <div className="flex items-center gap-1 sm:gap-2">
                    ...
                    <span className="text-black text-sm hidden sm:inline">Popularity</span>
                  </div>
                )}
              </div>
          ...
          {["overview", "seasons", "networks", "details"].map((tab) => (
            <button
              ...
              className={`pb-4 px-2 capitalize font-medium transition-colors whitespace-nowrap text-sm sm:text-base ${
                activeTab === tab ? "text-red-500 border-b-2 border-red-500" : "text-black hover:text-white"
              }`}
            >
              {tab}
            </button>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                  <Card className="bg-gray-800 border-gray-700">
                    <CardContent className="p-3 sm:p-4 text-center">
                      ...
                      <div className="text-black text-xs sm:text-sm">First Aired</div>
                    </CardContent>
                  </Card>
                  <Card className="bg-gray-800 border-gray-700">
                    <CardContent className="p-3 sm:p-4 text-center">
                      ...
                      <div className="text-black text-xs sm:text-sm">Seasons</div>
                    </CardContent>
                  </Card>
                  <Card className="bg-gray-800 border-gray-700">
                    <CardContent className="p-3 sm:p-4 text-center">
                      ...
                      <div className="text-black text-xs sm:text-sm">Episodes</div>
                    </CardContent>
                  </Card>
                  <Card className="bg-gray-800 border-gray-700">
                    <CardContent className="p-3 sm:p-4 text-center">
                      ...
                      <div className="text-black text-xs sm:text-sm">Runtime</div>
                    </CardContent>
                  </Card>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  {tvDetails.first_air_date && (
                    <div className="flex justify-between text-sm sm:text-base">
                      <span className="text-black">First Air Date:</span>
                      <span>{formatDate(tvDetails.first_air_date)}</span>
                    </div>
                  )}
                  {tvDetails.last_air_date && (
                    <div className="flex justify-between text-sm sm:text-base">
                      <span className="text-black">Last Air Date:</span>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {tvDetails.spoken_languages.map((lang) => (
                      <Badge key={lang.iso_639_1} variant="outline" className="border-gray-600 text-black text-xs">
                        {lang.english_name}
                      </Badge>
                    ))}
                  </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {tvDetails.origin_country.map((country) => (
                      <Badge key={country} variant="outline" className="border-gray-600 text-black text-xs">
                  ...
                  <CardContent className="p-4 sm:p-6">
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-black text-xs sm:text-sm mb-2">{season.episode_count} episodes</p>
                        {season.air_date && (
                          <p className="text-black text-xs">Aired: {formatDate(season.air_date)}</p>
                        )}
                        {season.overview && (
                          <p className="text-black text-xs mt-2 line-clamp-3">{season.overview}</p>
                        )}
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <CardContent className="p-4 sm:p-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-black text-xs sm:text-sm">{network.origin_country || "Unknown"}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="text-black text-xs">{company.origin_country || "Unknown"}</p>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                {tvDetails.original_name && (
                  <div className="flex justify-between py-2 border-b border-gray-700 text-sm sm:text-base">
                    <span className="text-black">Original Name</span>
                ...
                {tvDetails.in_production !== undefined && (
                  <div className="flex justify-between py-2 border-b border-gray-700 text-sm sm:text-base">
                    <span className="text-black">In Production</span>
                ...
                <Card className="bg-gray-800 border-gray-700">
                  <CardContent className="p-4">
                    <div className="text-center">
                      ...
                      <div className="text-black text-sm">Total Seasons</div>
                    </div>
                  </CardContent>
                </Card>
                <Card className="bg-gray-800 border-gray-700">
                  <CardContent className="p-4">
                    <div className="text-center">
                      ...
                      <div className="text-black text-sm">Total Episodes</div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <Card className="bg-gray-800 border-gray-700">
                    <CardContent className="p-4">
                      <div className="text-center">
                        ...
                        <div className="text-black text-sm">Average Episode Length</div>
                      </div>
                    </CardContent>
                  </Card>
                )}
