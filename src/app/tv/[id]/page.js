...
const getStatusColor = (status) => {
  switch (status?.toLowerCase()) {
    ...
    default:
      return "text-white" // Changed from text-black to text-white to match movie component
  }
}
          ...
          {["overview", "seasons", "networks", "details"].map((tab) => (
            <button
              ...
              className={`pb-4 px-2 capitalize font-medium transition-colors whitespace-nowrap text-sm sm:text-base ${
                activeTab === tab ? "text-red-500 border-b-2 border-red-500" : "text-white hover:text-gray-300"
              }`}
            >
              {tab}
            </button>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                  <Card className="bg-gray-800 border-gray-700">
                    <CardContent className="p-3 sm:p-4 text-center">
                      ...
                      <div className="text-white text-xs sm:text-sm">First Aired</div>
                    </CardContent>
                  </Card>
                  <Card className="bg-gray-800 border-gray-700">
                    <CardContent className="p-3 sm:p-4 text-center">
                      ...
                      <div className="text-white text-xs sm:text-sm">Seasons</div>
                    </CardContent>
                  </Card>
                  <Card className="bg-gray-800 border-gray-700">
                    <CardContent className="p-3 sm:p-4 text-center">
                      ...
                      <div className="text-white text-xs sm:text-sm">Episodes</div>
                    </CardContent>
                  </Card>
                  <Card className="bg-gray-800 border-gray-700">
                    <CardContent className="p-3 sm:p-4 text-center">
                      ...
                      <div className="text-white text-xs sm:text-sm">Runtime</div>
                    </CardContent>
                  </Card>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  {tvDetails.first_air_date && (
                    <div className="flex justify-between text-sm sm:text-base">
                      <span className="text-white">First Air Date:</span>
                      <span>{formatDate(tvDetails.first_air_date)}</span>
                    </div>
                  )}
                  {tvDetails.last_air_date && (
                    <div className="flex justify-between text-sm sm:text-base">
                      <span className="text-white">Last Air Date:</span>
                  ...
                  <CardContent className="p-4 sm:p-6">
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-white text-xs sm:text-sm mb-2">{season.episode_count} episodes</p>
                        {season.air_date && (
                          <p className="text-white text-xs">Aired: {formatDate(season.air_date)}</p>
                        )}
                        {season.overview && (
                  ...
                  <CardContent className="p-4 sm:p-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-white text-xs sm:text-sm">{network.origin_country || "Unknown"}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="text-white text-xs">{company.origin_country || "Unknown"}</p>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
                ...
                <Card className="bg-gray-800 border-gray-700">
                  <CardContent className="p-4">
                    <div className="text-center">
                      ...
                      <div className="text-white text-sm">Total Seasons</div>
                    </div>
                  </CardContent>
                </Card>
                <Card className="bg-gray-800 border-gray-700">
                  <CardContent className="p-4">
                    <div className="text-center">
                      ...
                      <div className="text-white text-sm">Total Episodes</div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <Card className="bg-gray-800 border-gray-700">
                    <CardContent className="p-4">
                      <div className="text-center">
                        ...
                        <div className="text-white text-sm">Average Episode Length</div>
                      </div>
                    </CardContent>
                  </Card>
                )}
