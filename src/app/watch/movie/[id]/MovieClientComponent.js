"use client";
import { Star, Calendar, Clock, Globe, Wifi, WifiOff, Server, Heart, Share2, Download, Eye, Zap } from "lucide-react";
...
// Removed useParams and axios from here as initial data is passed from the server.

export const MovieClientComponent = ({ initialMovieData, movieId, servers }) => {
    
    // Initialize state with data passed from the server
    const [movie] = useState(initialMovieData);
    ...
    // Helper functions (kept outside the return for clarity)
                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="relative mb-8">
                            <div className="relative aspect-video rounded-xl overflow-hidden shadow-2xl border border-gray-700">
                                ...
                                <iframe
                                    // Use movieId passed from the Server Component
                                    src={`${selectedServer.baseUrl}/${movieId}`}
                                    allowFullScreen
                                    scrolling="no"
                                    width="100%"
                                    height="100%"
            ...
            <div className="relative z-10 px-4 md:px-16 pb-16">
                <div className="max-w-7xl mx-auto">
                    <div className="grid lg:grid-cols-3 gap-8">
                        {/* Movie Information (can include overview/plot here) */}
                            ...
                            <Card className="bg-gray-800/50 backdrop-blur-sm border-gray-700">
                                <CardContent className="p-6">
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                        {/* ... Status details (Location, Quality, Latency, Speed) ... */}
